...
data_dir="/home/dongdong/2project/gaosi_slam/comale_srt/v1_1_slam_tool-main/data/ex2_testdata"
colmap_images_txt="${data_dir}/sparse/0/images.txt"   # 输入图像colmap重建位姿结果
gps_txt="${data_dir}/gnss.txt" # 输入图像GNSS数据txt (时间戳 经纬高 空格分开)
gps_intPionts="${data_dir}/GNSS_config.yaml" #输入图像gnss参考点输入文件
colmap2gnss_SRt_xml="${data_dir}/srt_colmap2gnss.yaml" #输出计算的srt关系保存路径
