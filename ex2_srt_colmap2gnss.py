...
if __name__ == "__main__":
    ...
    # 添加参数
    parser.add_argument('--colmap_images_txt', type=str, help='images.txt文件的路径')
    ...
    COLMAP_ENU_LIST = read_colmapPose_imageText(colmap_images_txt)
    ...
    for gnss_name in GNSS_ENU_LIST.keys():
        ...
        if COLMAP_ENU_LIST.get(gnss_name):
            points_src_colmap.append(COLMAP_ENU_LIST[gnss_name])
